    ...
    <div>
        ...
        <nav className={
            ...
            <div className="relative mt-14">
                ...
                <input type="text" placeholder="Search" className="w-full bg-gray-50 rounded pl-10 pr-10 py-1 border-b-2 text-xl border-gray-200 focus:outline-none focus:border-blur-500" />
