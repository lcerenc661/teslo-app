...
import { createUpdateProducts, deleteProductImage } from "@/actions";
...
interface FormInputs {
  ...
  inStock: number;
  sizes: string[];
  tags: string; // Shirt, Tshirt, Blouse
...
export const ProductForm = ({ product, categories }: Props) => {
  ...
  const onSubmit = async (data: FormInputs) => {
    ...
    const { ok, updatedProduct } = await createUpdateProducts(formData);
    if (!ok) {
      alert("Unable to updated product");
      return;
    }
